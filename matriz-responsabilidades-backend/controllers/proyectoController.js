...
const { nombre_proyecto, descripcion, fecha_inicio, fecha_fin,
id_usuario } = req.body;
try {
const nuevoProyecto = await Proyecto.create({ nombre_proyecto,

descripcion, fecha_inicio, fecha_fin, id_usuario });
...
try {
const proyectos = await Proyecto.findAll({ where: { id_usuario:
...
id_usuario } = req.body;
try {
await Proyecto.update({ nombre_proyecto, descripcion,

fecha_inicio, fecha_fin, id_usuario }, { where: { id_proyecto: id } });
